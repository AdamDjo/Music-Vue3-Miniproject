<template>
  ...
  <vee-form :validation-schema="schema" @submit="register" :initial-values="userData">
    ...
    <div class="mb-3">
      ...
      <vee-field name="password" :bails="false" v-slot="{ field, errors }" type="password">
        <input
          class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition duration-500 focus:outline-none focus:border-black rounded"
    ...
    <div class="mb-3">
      ...
      >
        ...
        <option value="notacountry">NotAcountry</option>
      </vee-field>
...
<script>
import { auth, usersCollection } from '@/plugins/firebase/firebase'
export default {
  name: 'RegisterForm',
  data() {
    return {
      ...
      schema: {
        ...
        country: 'required|country_excluded:notacountry',
        tos: 'tos'
      },
